export const amethystPages = [
  ...
  { text: [`It's in equal parts awe and curiosity `, `that you decide...`] },
  { text: [`to step into the realm.`] },
  {
    text: [`~`],
    overlaySettings: {
  ...
  {
    text: [
      `While nothing else is in sight, `,
      `you know you are not alone here.`,
    ],
  },
  {
    text: [
  ...
  },
  {
    text: [`~`],
    overlaySettings: {
      backgroundColor: 'rgb(117, 102, 119)',
      color: 'rgba(225, 225, 225, 0.8)',
    },
  },
  { text: [`Where does the water get that color?`] },
  {
    text: [
      `You've often wondered if the gentle violet tint comes from the light, `,
      `or if you're seeing the sparkling water's natural shade.`,
    ],
  },
  { text: [`The mirror below glistens like a gem.`] },
  {
    text: [
  ...
  { text: [`So you keep coming back.`] },
  { text: [`To learn the exotic vernacular.\n`, `One stroke at a time.`] },
  {
    text: [
  ...
  {
    overlaySettings: {
      backgroundColor: 'rgb(99,130,128)',
      color: 'rgba(225, 225, 225, 0.8)',
    },
    text: [`~`],
  },
  ...
  { text: [`You hear the drone first... `] },
  { text: [`...then `, `a gentle vibration sits at the edge of your vision.`] },
  {
    text: [` `],
    overlaySettings: {
  ...
  { text: [`You start to think you'll never reach the root.`] },
  {
    text: [
  ...
  { text: [`Thankfully, `, `it doesn't seem to matter.`] },
  { text: [`You realize `, `that the sweetness of the tone...`] },
  { text: [`...is in the resonance.`] },
  {
    text: [`~`],
    overlaySettings: {
